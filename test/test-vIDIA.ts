...
export default describe('vIDIA', function () {
  ...
  it('test claimstaked', async () => {
    ...
    for (let i = 0; i < testCases.length; i++) {
      const fee = feePercentBasisPts
        .mul(testCases[i])
        .div(ethers.BigNumber.from('10000')) // 10000 basis pts = 100%
